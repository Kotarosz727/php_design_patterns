...
class HondaFactory implements FactoryInterface
{
...
class HondaTire implements TireInterface
{
    protected $json;
...
class HondaHandle implements HandleInterface
{
    protected $json;
